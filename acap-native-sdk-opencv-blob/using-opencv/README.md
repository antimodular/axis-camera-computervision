...
1. Open previously installed docker desktop app.

2. Standing in your working directory run the following commands:
...
3. You should now have a `build` directory. In it is the `.eap` file that is
   your application.  Upload the application to your camera.
4. Start the application. In the `App log`, a printout from the application
